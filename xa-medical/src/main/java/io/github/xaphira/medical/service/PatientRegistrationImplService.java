package io.github.xaphira.medical.service;
...
public class PatientRegistrationImplService {
    ...
    public String patientRegister(PatientRegistrationDto patientRegistrationDto){
        String url = "http://10.10.105.225:9993/server/testLogin?username=";
        response = getRestTemplate().postForObject(url, patientRegistrationDto,String.class);
        return response;
    }
